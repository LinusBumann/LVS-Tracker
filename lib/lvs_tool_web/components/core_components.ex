defmodule LvsToolWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: LvsToolWeb.Gettext
  ...
  def modal(assigns) do
    ...
    >
      <div
        id={"#{@id}-bg"}
        class="bg-zinc-100/50 backdrop-blur-lg fixed inset-0 transition-opacity"
        aria-hidden="true"
      />
      <div
  ...
  def icon_button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "text-sm font-semibold leading-6 bg-orange-500 hover:bg-orange-400 text-white",
    ...
    >
      <div class="flex items-center gap-2">
        <img src={@image_src} alt="Icon" class="h-10 w-10" /> {render_slot(@inner_block)}
      </div>
    </button>
    """
  end
  ...
  @doc """
  Renders a login or register button.
  """
  attr :type, :string, default: nil
  attr :class, :string, default: nil
  attr :rest, :global, include: ~w(disabled form name value)
  ...
  def login_register_button(assigns) do
    ~H"""
    <button
      type={@type}
      class={[
    ...
    <button
      ...
      class={[
        ...
        if(@class == nil or @class == "",
          do: "bg-orange-500 hover:bg-orange-400 text-white active:bg-orange-600",
          else: ""
        ),
        @class
      ]}
  ...
  def table(assigns) do
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="w-[40rem] mt-11 sm:w-full">
        <thead class="text-s text-left leading-6 text-zinc-500">
          <tr>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LvsToolWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LvsToolWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def accordion(assigns) do
    ...
    <div class="bg-white rounded-lg border border-gray-200 overflow-auto shadow-md">
      ...
      <div class="max-h-0 overflow-hidden transition-all duration-500 ease-in-out peer-checked:max-h-none peer-checked:overflow-visible">
