defmodule LvsTool.Accounts.User do
  use Ecto.Schema
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email, :password, :name, :role_id])
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, LvsTool.Repo)
  ...
  """
  def valid_password?(%LvsTool.Accounts.User{hashed_password: hashed_password}, password)
  ...
  @doc """
  Ein User-Changeset für die Namensänderung.
  """
